...
<div class="row m-0 w-100">
        <div class="post-comments col-md-7 mt-md-5 mx-md-auto me-md-0">
            <section id="post">
                ...
                <div class="post-text p-2">
                    ...
                    <div class="post-buttons align-items-center">
                        ...
                        <button class="edit">
                            <a href="edit_post.php" class="text-decoration-none text-reset">
                                <span class="material-icons">
                                    create
                                </span>
                            </a>
            ...
            <form class="add-comment">
                ...
                <button type="submit" class="btn btn-primary btn-default float-end">Post</button>
            </form>
    ...
    <div class="newpost col col-md-2 mx-md-auto m-3 m-md-5 mb-0 order-first order-md-last">
        <div class="card">
            <div class="card-body d-flex flex-column justify-content-center">
                ...
                <form id="form_ask_question" name="ask_question" action="./create_post.php">
